...
"""
USAGE:
	./ora2json.py  -g oats@jc1lbiorc7:1521/ORADB1S -s in_sql.sql -o out_json.json -a 10000 -c 0
...
if __name__ == "__main__":
	...
	parser = OptionParser()
	parser.add_option("-g", "--db_login", dest="db_login", type=str, default='oats@jc1lbiorc7:1521/ORADB1S')
